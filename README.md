...
1. fetch와 로컬스토리지를 이용하여 회원가입 및 로그인 창 제작<br/>
2. 회원가입, 아이디 및 비밀번호 찾기 구현 <br/><br/>
...
## :hammer: 주요기능
### ✅ 회원가입 <br/> 
1. 전체 내용 입력해야 버튼 활성화 <br/>
2. 아이디(이메일) 중복 검사 가능 (로컬스토리지 데이터와 비교) <br/>
3. 비밀번호 재확인 가능 <br/>
...
### ✅ 로그인 <br/> 
1. 로컬스토리지에 저장된 아이디와 비밀번호 일치 시 로그인 가능 <br/>
2. 로그인 실패 시 alert, 로그인 성공 시 환영합니다 페이지로 이동 (render) <br/>
<div align="center">
<img width="80%" src="https://github.com/user-attachments/assets/7d6835a0-c418-4658-b8a7-e58097a882da"/></div>
<br/>

### ✅ 아이디 & 비밀번호 찾기 <br/> 
1. 전화번호로 아이디 찾기(로컬스토리지와 비교) <br/>
2. 아이디로 비밀번호 찾기(로컬스토리지와 비교) <br/>
